...
from pymoveit2.robots import xarm5
...
def main():
    ...
    moveit2_gripper = MoveIt2Gripper(
        node=node,
        gripper_joint_names=xarm5.gripper_joint_names(),
        open_gripper_joint_positions=xarm5.OPEN_GRIPPER_JOINT_POSITIONS,
        closed_gripper_joint_positions=xarm5.CLOSED_GRIPPER_JOINT_POSITIONS,
        gripper_group_name=xarm5.MOVE_GROUP_GRIPPER,
